...
import { bindAgendaEventModalActions, setAgendaEvents } from "./components/agendaEventModal.js?v=0.23.10";
...
import {
  ...
  bindPayslipModal
} from "./hrProfile/index.js?v=0.23.10";
import {
  JOURNEY_ROUTE,
  isJourneyModuleSlug,
...
function renderShell(data, route) {
  ...
  setAgendaEvents(
    data.agenda?.items?.length
      ? data.agenda.items
      : collectAgendaEventsFromPanels([...(data.leftPanels || []), ...(data.rightPanels || [])])
  );
