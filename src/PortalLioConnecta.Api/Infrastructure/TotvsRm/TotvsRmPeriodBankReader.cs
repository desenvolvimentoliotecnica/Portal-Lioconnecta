...
{
    private static readonly string[] PreviousBalanceColumns = ["SALDOANTERIOR", "SALDOANT", "SALDOANTER", "SALDOANTERIORBH"];
    private static readonly string[] PeriodBalanceColumns = ["SALDOPERIODO", "SALDOPER", "SALDOATUALPER", "SALDOPERIODOBH"];
    private static readonly string[] TotalBalanceColumns = ["SALDOATUAL", "SALDOFINAL", "SALDOTOTAL", "SALDOACUMULADO", "SALDO"];
    private static readonly string[] PeriodStartColumns = ["INICIOMENSAL", "DATAINICIO", "DATINICIO", "INICIO", "DATAINI"];
    private static readonly string[] PeriodEndColumns = ["FIMMENSAL", "DATAFIM", "DATFIM", "FIM", "DATAFIM"];
    ...
    {
        foreach (var tableName in new[] { "ACOMPFUN", "ABANCOHORFUNDETALHE", "ASALDOBANCOHOR" })
        {
