...
builder.Services.AddScoped<IFeedInteractionNotificationService, FeedInteractionNotificationService>();
...
{
    builder.Services.AddDbContext<PortalLioConnectaDbContext>(options =>
        options.UseNpgsql(connectionString));
}

var app = builder.Build();
await PortalLioConnectaDbInitializer.InitializeAsync(app.Services);
