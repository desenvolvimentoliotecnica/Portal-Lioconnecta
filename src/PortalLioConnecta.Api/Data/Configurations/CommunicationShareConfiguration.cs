...
public class CommunicationShareConfiguration : IEntityTypeConfiguration<CommunicationShare>
{
    public void Configure(EntityTypeBuilder<CommunicationShare> builder)
    {
        builder.ToTable("communication_shares");
