...
public class CommunicationLikeConfiguration : IEntityTypeConfiguration<CommunicationLike>
{
    public void Configure(EntityTypeBuilder<CommunicationLike> builder)
    {
        builder.ToTable("communication_likes");
