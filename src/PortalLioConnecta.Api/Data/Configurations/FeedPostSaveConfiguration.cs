...
public class FeedPostSaveConfiguration : IEntityTypeConfiguration<FeedPostSave>
{
    public void Configure(EntityTypeBuilder<FeedPostSave> builder)
    {
        builder.ToTable("feed_post_saves");
