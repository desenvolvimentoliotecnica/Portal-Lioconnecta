...
namespace PortalLioConnecta.Api.Data;

public class PortalLioConnectaDbContext : DbContext
{
    public PortalLioConnectaDbContext(DbContextOptions<PortalLioConnectaDbContext> options)
        : base(options)
    {
    }
    ...
    {
        modelBuilder.ApplyConfigurationsFromAssembly(typeof(PortalLioConnectaDbContext).Assembly);
